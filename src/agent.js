...
SCHÉMA JSON OBLIGATOIRE :
{
  ...
  "seo_excerpt": "Ceci correspond au 'Récapitulatif' du produit. Tu DOIS générer une liste à puces HTML (<ul><li>...</li></ul>) contenant les 4/5 spécifications majeures. RÈGLE CRITIQUE ABSOLUE : La longueur totale de ce texte HTML NE DOIT JAMAIS DEPASSER 350 CARACTÈRES. L'IA a tendance à faire trop long, sois extrêmement court et concis. Utilise du CSS inline pour colorer le texte. Exemple : <ul><li style='margin-bottom:4px;'>CPU: <strong style='color:#ea580c'>i5</strong></li></ul>. Uniquement du HTML.",
    "meta_title": "Titre SEO très optimisé pour la vente (max 60 caractères). Exemple: Acheter [Produit] en Tunisie, ou [Produit] Sousse Tunisie. RÈGLES : Uniquement lettres, chiffres et tirets. INTERDIT : emojis, symboles (< > = { } ; \" ').",
    "meta_keywords": "Génère 10 mots-clés intelligents, locaux et pertinents séparés par des virgules pour maximiser le SEO en Tunisie. (ex: acheter [Produit] sousse, [Marque] tunisie prix, meilleur [catégorie] sousse). INTERDIT : emojis, symboles spéciaux.",
    "meta_description": "Phrase courte et très vendeuse (max 150 caractères) ciblée sur le marché tunisien, mentionnant la livraison ou la disponibilité à Sousse/Tunisie. RÈGLES : Uniquement lettres, chiffres, virgules et points. INTERDIT : sauts de ligne, emojis, symboles.",
